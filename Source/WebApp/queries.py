QUERY_CREATE_TABLE_USERS = "CREATE TABLE IF NOT EXISTS USERS (ID INTEGER PRIMARY KEY AUTOINCREMENT, ISADMIN INTEGER NOT NULL, USERNAME NVARCHAR(255) NOT NULL UNIQUE, PASSWORD VARBINARY(255) NOT NULL, SALT NVARCHAR(255) NOT NULL, PICTURE NVARCHAR(1024) DEFAULT 'default.png');"
