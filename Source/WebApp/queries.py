QUERY_CREATE_TABLE_USERS = "CREATE TABLE IF NOT EXISTS USERS (USERNAME NVARCHAR(255) PRIMARY KEY, ISADMIN INTEGER NOT NULL, PASSWORD VARBINARY(255) NOT NULL, SALT NVARCHAR(255) NOT NULL, PICTURE NVARCHAR(1024) DEFAULT 'default.png', LOGGEDIN INTEGER NOT NULL);"
...
QUERY_USERS_INSERT = '''INSERT INTO USERS (USERNAME, ISADMIN, PASSWORD, SALT, LOGGEDIN) VALUES (?, ?, ?, ?, ?);'''
