...
#queries.py contains a list of parameterized prepared SQL statements
...
QUERY_USERS_GET_ISADMIN_ANY = '''SELECT ISADMIN FROM USERS WHERE ISADMIN == 1;'''
...
QUERY_AUTHORIZEDUSERS_UPDATE_USERNAME = '''UPDATE AUTHORIZEDUSERS SET USERNAME = ? WHERE USERNAME == ?;'''

QUERY_AUTHORIZEDUSERS_DELETE = '''DELETE FROM AUTHORIZEDUSERS WHERE USERNAME == ?;'''

QUERY_VIDEOS_INSERT = '''INSERT INTO VIDEOS (NAME, USERS, TIME) VALUES (?, ?, CURRENT_TIMESTAMP);'''

QUERY_VIDEOS_GET_ALL = '''SELECT * FROM VIDEOS WHERE 1==1 ORDER BY TIME DESC;'''

QUERY_VIDEOS_GET_USERS = '''SELECT USERS FROM VIDEOS WHERE 1==1;'''

QUERY_VIDEOS_UPDATE_USERS = '''UPDATE VIDEOS SET USERS = ? WHERE USERS == ?;'''

QUERY_VIDEOS_DELETE_EMPTY = '''DELETE FROM VIDEOS WHERE USERS IS NULL OR USERS == '';'''
